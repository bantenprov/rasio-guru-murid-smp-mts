...
/* require */<?php namespace Bantenprov\RasioGMSmpMts\Http\Controllers;
...
class RasioGMSmpMtsController extends Controller
{
    ...
    protected $rasio_guru_murid_smp_mts;

    public function __construct(Regency $regency, Province $province, PdrbModel $rasio_guru_murid_smp_mts)
    {
        $this->regency  = $regency;
        $this->province = $province;
        $this->rasio_guru_murid_smp_mts     = $rasio_guru_murid_smp_mts;
    }
    ...
    public function show($id)
    {
        ...
        $rasio_guru_murid_smp_mts = $this->rasio_guru_murid_smp_mts->find($id);

        return response()->json([
            'negara'    => $rasio_guru_murid_smp_mts->negara,
            'province'  => $rasio_guru_murid_smp_mts->getProvince->name,
            'regencies' => $rasio_guru_murid_smp_mts->getRegency->name,
            'tahun'     => $rasio_guru_murid_smp_mts->tahun,
            'data'      => $rasio_guru_murid_smp_mts->data
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $check = $this->rasio_guru_murid_smp_mts->where('regency_id',$request->regency_id)->where('tahun',$request->tahun)->count();
        ...
        if($check > 0)
        {
            ...
            $data = $this->rasio_guru_murid_smp_mts->create($request->all());
